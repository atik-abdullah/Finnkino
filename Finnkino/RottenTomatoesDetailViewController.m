...
-(void) configureView
{
    ...
    NSString *criticsScorePercent = [[[self.selection criticsScoreElement] criticsScore] stringByAppendingString:@"%"];
    NSString *audienceScorePercent = [[[self.selection audienceScoreElement] audienceScore] stringByAppendingString:@"%"];
