...
@interface FKTAddWaterMarkCommand()

-(CALayer*)watermarkLayerForSize:(CGSize)videoSize;

@end

@implementation FKTAddWaterMarkCommand
...
- (CALayer*)watermarkLayerForSize:(CGSize)videoSize
{
	...
	titleLayer.font = (__bridge void*)[UIFont fontWithName:@"Helvetica" size:videoSize.height/2] ;
